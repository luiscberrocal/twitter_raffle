"""
Django settings for Twitter Raffle project.
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'twitter_raffle.contrib.sites.migrations'
}
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///twitter_raffle'),
}
...
ACCOUNT_ADAPTER = 'twitter_raffle.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'twitter_raffle.users.adapters.SocialAccountAdapter'
...
########## CELERY
INSTALLED_APPS += ['twitter_raffle.taskapp.celery.CeleryConfig']
